	...
	const albums = [
		{
			title: 'Hip-Hop',
			count: 120,
			bg: 'bg-gradient-to-br from-orange-500 via-purple-700 to-black'
		},
		{
			title: 'Indie',
			count: 34,
			bg: 'bg-gradient-to-br from-cyan-400 via-rose-400 to-red-500'
		},
		{
			title: 'Pop',
			count: 100,
			bg: 'bg-gradient-to-br from-pink-300 via-blue-500 to-indigo-700'
		},
		{
			title: 'Rap',
			count: 49,
			bg: 'bg-gradient-to-br from-purple-700 via-fuchsia-600 to-indigo-800'
		}
	];
</script>
